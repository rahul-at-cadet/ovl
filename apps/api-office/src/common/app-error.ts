 ...
 * and coded every single one as INTERNAL_SERVER_ERROR. An invalid schema
 * upload and a real crash were indistinguishable to a client.
 *
 ...
 *
 * Kept in step with apps/api-vessel/src/common/app-error.ts. The two
