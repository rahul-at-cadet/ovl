    ...
    <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-700 max-w-6xl">
      ...
      <Tabs defaultValue="network" orientation="vertical" className="w-full">
        <div className="flex flex-col md:flex-row gap-4 md:gap-6 w-full min-w-0">
          <TabsList ref={tabsRef} className="max-md:!flex-row max-md:!w-full max-md:!justify-start h-auto bg-transparent gap-1 md:gap-1 w-full md:w-60 shrink-0 max-md:overflow-x-auto max-md:overflow-y-hidden md:overflow-visible p-0 rounded-none border-b border-border md:border-b-0 md:border-r md:pr-2">
            <TabsTrigger 
              value="network" 
              className="max-md:!w-auto justify-start px-3 min-h-12 text-sm font-medium whitespace-nowrap shrink-0 rounded-sm text-muted-foreground hover:bg-surface-hover data-active:bg-surface-active data-active:text-foreground data-active:font-semibold data-active:shadow-none"
            >
          ...
          <div className="flex-1 space-y-6">
            <TabsContent value="network" className="mt-0 space-y-6">
              <Card className="bg-card border-border overflow-hidden rounded-sm shadow-none">
                <CardHeader className="border-b border-border pb-4 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
                  <div>
                  ...
                  <Button variant="outline" onClick={handleForceSync} disabled={syncNowMutation.isPending} className="w-full sm:w-auto justify-center shrink-0">
            ...
            <TabsContent value="sensors" className="mt-0">
              <Card className="bg-card border-border overflow-hidden rounded-sm shadow-none">
                ...
                <CardContent className="pt-6 space-y-4">
                  ...
                  <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 py-3 border-b border-border last:border-b-0">
                    <div>
