  ...
  const [queryClient] = useState(
    () =>
      new QueryClient({
         ...
         * remember. That matters most for a vessel: this node spends real
         * time offline, so a mutation failing because shore is unreachable
         * is an ordinary event the officer has to be told about.
         *
